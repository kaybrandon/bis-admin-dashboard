...
public record UserCreateRequest(string Name, string Email, string Role, Guid? DepartmentId, Guid? ManagerId, string? PhoneMobile, string? PhoneWork, string? Ext, string? Title, string? Password, string? Notes, string? CoveringFor, string? Birthday, int? BirthdayMonth, int? BirthdayDay, int? BirthdayYear, bool? ClearBirthday, string? WorkAnniversary, int? WorkAnniversaryMonth, int? WorkAnniversaryDay, int? WorkAnniversaryYear, bool? ClearWorkAnniversary);
...
public record TeamUpdateRequest(string? Name, string? Email, string? Role, string? Title, Guid? DepartmentId, Guid? ManagerId, bool? ClearDepartment, bool? ClearManager, string? PhoneMobile, string? PhoneWork, string? Ext, string? Notes, string? CoveringFor, string? Birthday, int? BirthdayMonth, int? BirthdayDay, int? BirthdayYear, bool? ClearBirthday, string? WorkAnniversary, int? WorkAnniversaryMonth, int? WorkAnniversaryDay, int? WorkAnniversaryYear, bool? ClearWorkAnniversary);
